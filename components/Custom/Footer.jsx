    ...
    <footer className="border-t border-gray-200 py-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="mb-4">
              <Link href="/" className="text-xl font-medium">
                <span className="text-amber-500">E</span>com
              </Link>
            </div>
          ...
          {/* Shopping Online Column - Right Aligned */}
          <div className="md:col-span-1">
            <h3 className="font-medium text-lg mb-5">Shopping online</h3>
          ...
          {/* Information Column */}
          <div className="md:col-span-1">
            <h3 className="font-medium text-lg mb-5">Information</h3>
            <ul className="space-y-3">
              <li>
